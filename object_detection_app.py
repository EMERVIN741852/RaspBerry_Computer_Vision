...
#default de altura - 360
#default de largura - 480
...
if __name__ == '__main__':
    ...
    while True:  # fps._numFrames < 120
        ...
        cv2.imshow('CHANGE VISION IA', output_rgb)
        fps.update()
    ...
    fps.stop()
    print("OBTENDO OS DADOS COM SUCESSO - CHANGE VISION IA")
